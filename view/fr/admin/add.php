...
<div class="container">
    <div class="row mui-panel" id="the_menu">
        <h2 class="title">Remplissez le formulaire pour ajouter <?php echo $this->thing["title"] . " " . $this->thing["name"]; ?></h2>
    </div>
    ...
    <form action="/admin/add/<?php echo $this->thing["slug"] ?>" method="post" class="row" enctype="multipart/form-data">
        ...
        <div class="row endButton">
            <button class="btn waves-effect" type="submit">Ajouter <?php echo $this->thing["name"]; ?></button>
        </div>
    </form>
</div>
</body>
