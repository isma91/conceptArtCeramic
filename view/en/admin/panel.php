...
<div class="container">
    <div class="row mui-panel">
        <h2 class="title">Welcome <?php echo $this->firstname; ?> <?php echo $this->lastname; ?></h2>
    </div>
    ...
    <div class="row">
        <div class="col s12">
            <ul class="tabs">
                <li class="tab col s3"><a href="#contact">Contact Message</a></li>
                <li class="tab col s3"><a href="#devis">Estimate Message</a></li>
            </ul>
        </div>
        <div id="contact" class="row">
            <p class="title">Contact Messages</p>
            <table>
                <thead>
                <tr>
        ...
        <div id="devis" class="row">
            <p class="title">Estimate Message</p>
            <table>
                <thead>
                <tr>
                    <th data-field="name">Name</th>
